# -*- coding: utf-8 -*-
#
# CropClassification documentation build configuration file, created by
# sphinx-quickstart.
#
...
htmlhelp_basename = 'CropClassificationdoc'
...
latex_documents = [
    ('index',
     'CropClassification.tex',
     u'CropClassification Documentation',
     u"Uzair Shafique", 'manual'),
]
...
man_pages = [
    ('index', 'CropClassification', u'CropClassification Documentation',
     [u"Uzair Shafique"], 1)
]
